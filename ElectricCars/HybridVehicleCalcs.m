...
DS(j).ISO=ISO;
DS(j).Ncars=Ncars;
DS(j).CurrentFractionCars=etaHV;
DS(j).Effectiveness=Effectiveness;
DS(j).AdoptionCurrent=etaHV*Ncars*Distancepkm/1e6;
DS(j).AdoptionLow=0.44*Ncars*Distancepkm/1e6;
DS(j).AdoptionHigh=0.80*Ncars*Distancepkm/1e6;
DS(j).ImpactCurrent=Effectiveness*etaHV*Ncars*Distancepkm/1e12;
