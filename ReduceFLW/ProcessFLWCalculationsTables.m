...
% being explicit about SaveFileNameText - so it's clear how this relates to
% the calculation and approximations in CalculationsOfFLW
FLWColumnFlag='all';
ItemText='AllItems';
SaveFileNameText=[FLWColumnFlag '_' ItemText '_' num2str(YYYY)];
% % % Here's the code where this gets used:
